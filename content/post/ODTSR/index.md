  ...
  - block: contact
    content:
      ...
      text: |-
        ...
        ![图2：ODTSR与其他SOTA方法的在标准图像超分任务上的量化对比](640 (2).png)

        ![图3：ODTSR与其他SOTA方法的在标准图像超分任务上的量化对比](640 (3).png)

        ![图4：ODTSR与其他SOTA方法的视觉效果与细节对比](640 (4).png)

        ![图5：ODTSR的Prompt可控性展示](640 (5).png)
